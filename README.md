...
* **EssentialsX requires CraftBukkit, Spigot, Paper or Sponge, Neoforge, Forge, Fabric, Quilt(These APIS Require 2.22.2+) to run.** Other server software may work, but these are not tested
